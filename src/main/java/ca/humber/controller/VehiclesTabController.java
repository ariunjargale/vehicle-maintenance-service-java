...
public class VehiclesTabController implements Initializable {
    ...
    private ObservableList<Vehicle> vehicleList = FXCollections.observableArrayList();
        ...
        private void handleAddVehicle() {
            try {
                // This part should actually open a new dialog to collect vehicle information
                // For simplicity, just showing a message here
                AlertDialog.showSuccess("Add Vehicle", "This will open the new vehicle form");
                
                // In a real scenario, the code would look like:
        ...
        private void handleEditVehicle() {
            ...
            try {
                // This part should actually open a dialog pre-filled with the selected vehicle's data
                AlertDialog.showSuccess("Edit Vehicle", "Editing vehicle ID: " + selectedVehicle.getVehicleId());
        ...
        private void handleDeleteVehicle() {
            ...
            boolean confirm = AlertDialog.showConfirm("Confirm Deletion", 
                    "Are you sure you want to delete the vehicle " + selectedVehicle.getYear() + " " + selectedVehicle.getModel() + 
