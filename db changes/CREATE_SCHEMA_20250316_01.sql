...
CREATE TABLE SERVICE (
    ...
    SERVICE_TYPE_ID VARCHAR2(255) NOT NULL,
...
INSERT INTO USER_ROLE (ROLE_NAME) VALUES ('SALES');
...
INSERT INTO APPOINTMENT_STATUS (STATUS_ID, STATUS_NAME) VALUES ('P', 'PAID');

-- ADMIN USER password:password
Insert into USERS (USER_ID,USERNAME,PASSWORD,ROLE_ID,IS_ACTIVE) values ('admin','XohImNooBHFR0OVvjcYpJ3NgPQ1qq73WKhHvch0VQtg=',1,1);

-- ASSIGNING ALL PERMISSIONS TO ADMIN ROLE
Insert into ROLE_PERMISSION (PERMISSION_ID,ROLE_ID,TABLE_NAME,IS_READ_ONLY) values (1,'APPOINTMENT',0);
Insert into ROLE_PERMISSION (PERMISSION_ID,ROLE_ID,TABLE_NAME,IS_READ_ONLY) values (1,'CUSTOMER',0);
Insert into ROLE_PERMISSION (PERMISSION_ID,ROLE_ID,TABLE_NAME,IS_READ_ONLY) values (1,'INVENTORY',0);
Insert into ROLE_PERMISSION (PERMISSION_ID,ROLE_ID,TABLE_NAME,IS_READ_ONLY) values (1,'MECHANIC',0);
Insert into ROLE_PERMISSION (PERMISSION_ID,ROLE_ID,TABLE_NAME,IS_READ_ONLY) values (1,'SERVICE',0);
Insert into ROLE_PERMISSION (PERMISSION_ID,ROLE_ID,TABLE_NAME,IS_READ_ONLY) values (1,'USER_ROLE',0);
Insert into ROLE_PERMISSION (PERMISSION_ID,ROLE_ID,TABLE_NAME,IS_READ_ONLY) values (1,'USERS',0);
Insert into ROLE_PERMISSION (PERMISSION_ID,ROLE_ID,TABLE_NAME,IS_READ_ONLY) values (1,'VEHICLE',0);
